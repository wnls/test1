...
<head>
  ...
  <script>
    var relativeDir = "../../", thisFile = "node_modules/express/test.js", defaultSidebar = true;
  </script>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">express</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;./&#39;</span><span class="p">)</span>
